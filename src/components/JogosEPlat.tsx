...
const JogosEPlat = () => {
  return (
    <div className="bg-white p-12  border border-amber-300 relative">
      
      
      <div className="bg-amber-100 text-amber-900 px-4 py-1 rounded-full text-sm font-medium inline-block mb-6">
        INFORMAÇÃO
      </div>
